...
var BasketContents = /** @class */ (function () {
    function BasketContents(items) {
        if (items === void 0) { items = new Array(); }
        this.items = items;
    }
    BasketContents.prototype.getItems = function () {
        return this.items;
    };
    BasketContents.prototype.itemCount = function () {
        return this.items.length;
    };
    BasketContents.prototype.haveItem = function (id) {
        return (this.getItem(id) != null);
    };
    BasketContents.prototype.addItem = function (basketItem) {
        if (this.items.indexOf(basketItem) > -1) {
            return false;
        }
        this.items.push(basketItem);
    };
    BasketContents.prototype.getItem = function (id) {
        var result = null;
    ...
    BasketContents.prototype.removeItem = function (id) {
        var result = false;
        var item = this.getItem(id);
        var index = item != null ? this.items.indexOf(item) : -1;
        if (index > -1) {
