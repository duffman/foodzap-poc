...
(function (ServerMessageTypes) {
    ...
    })(Socket = ServerMessageTypes.Socket || (ServerMessageTypes.Socket = {}));
    let Error;
    (function (Error) {
        Error.msgMissingId = "msgMissingId";
    })(Error = ServerMessageTypes.Error || (ServerMessageTypes.Error = {}));
    let Event;
    (function (Event) {
        Event.msgHello = "msgHello";
        Event.msgNewConnection = "msgNewConnection";
    })(Event = ServerMessageTypes.Event || (ServerMessageTypes.Event = {}));
