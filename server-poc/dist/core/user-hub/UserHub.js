...
exports.UserHub = exports.SessionEntry = void 0;
...
let UserHub = class UserHub {
    ...
    getUserId(message, required = true) {
        ...
        cli_logger_1.Logger.log("sessionEntry.userSession", sessionEntry.userSession);
