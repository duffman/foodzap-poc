...
export class WebSocketCore implements INetworkSocket {
	public id: string;
	public timeout: number;

	constructor(private socket: WebSocket, socketId: string) {
		this.id = socketId;
	}
	...
	public emit(messageType: string, message: string): boolean {
		...
		//TODO: Investigate how we can make the WebSocket report done...
		return true;
	}
